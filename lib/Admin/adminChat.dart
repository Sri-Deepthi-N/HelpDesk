...
class _AdminChatState extends State<Adminchat> {
  ...
  // Function to fetch messages only
  ...
  Widget _buildMessage(Map<String, dynamic> message) {
    ...
    bool isIncharge = Iid.contains(message['sentBy']);;
    return Align(
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    enabled: widget.Status == 'Pending' || widget.Status == 'Reraised',
                  ),
                ),
                IconButton(
                  icon: Icon(Icons.send),
                  onPressed: widget.Status == 'Pending' || widget.Status == 'Reraised'
                      ? _sendMessage
                      : null,
                ),
              ],
